...
class TestControllerFunctions:
    ...
    def test_is_exit_choice_with_exit(self):
        ...
        from src.presentation.cli.core.controller import is_exit_choice
        from src.presentation.cli.core.cli_constants import EXIT_CHOICE
    ...
    def test_is_all_steps_choice_with_all(self):
        ...
        from src.presentation.cli.core.controller import is_all_steps_choice
        from src.presentation.cli.core.cli_constants import ALL_STEPS_CHOICE_OFFSET
    ...
    def test_is_valid_step_choice_valid(self):
        ...
        from src.presentation.cli.core.controller import is_valid_step_choice
...
class TestHandleUserChoice:
    ...
    def test_handle_valid_step_choice(self):
        ...
        with patch('src.presentation.cli.core.controller.execute_step_with_dependencies') as mock_exec:
    ...
    def test_handle_all_steps_choice(self):
        ...
        with patch('src.presentation.cli.core.controller.execute_all_steps') as mock_exec:
            mock_exec.return_value = True
