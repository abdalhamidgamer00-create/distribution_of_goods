...
def step_6_split_by_branches(use_latest_file: bool = None) -> bool:
    ...
    csv_files, branches_dir, analytics_dir = setup_and_validate(renamed_dir)
    if csv_files is None:
        return False
    
    return try_execute_split(renamed_dir, csv_files, branches_dir, analytics_dir, use_latest_file)
