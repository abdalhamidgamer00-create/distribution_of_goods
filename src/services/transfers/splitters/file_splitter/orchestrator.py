...
def process_transfer_file(
    transfer_file_path: str, transfers_base_dir: str, has_date_header: bool, 
    first_line: str, all_output_files: dict
) -> None:
...
def split_all_transfer_files(
    transfers_base_dir: str, has_date_header: bool = False, 
    first_line: str = ""
) -> dict:
    ...
    for file_path in paths.find_unsplit_files(transfers_base_dir, categories):
        process_transfer_file(
            file_path, transfers_base_dir, has_date_header, first_line, 
            all_output_files
        )
