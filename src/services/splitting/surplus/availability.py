...
def check_surplus_availability(branch_data: dict, other_branch: str, product_index: int, 
...
def should_skip_branch(other_branch: str, branch: str, remaining_capacity: float) -> bool:
